...
- User `postgres` available without a password for now
...
This is expected until you trust the local CA generated by Caddy. The CA material is stored under `data/caddy/data`.
