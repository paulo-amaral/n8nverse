...
- `certs/n8n.localhost.pem`
- `certs/n8n.localhost-key.pem`
...
```caddy
n8n.localhost {
	tls /certs/n8n.localhost.pem /certs/n8n.localhost-key.pem
...
If you want the browser to trust `https://n8n.localhost`, the `mkcert` CA used to sign it must be trusted by macOS.
...
To regenerate the certificate for `n8n.localhost`:
